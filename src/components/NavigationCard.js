...
function NavigationCard() {
  ...
  const activeElement =
    "flex md:gap-3 md:mx-0 py-4 bg-purple-500 text-white md:-mx-10 md:px-8 px-6 rounded-md shadow-lg shadow-purple-400";
  const hoveredElement =
    "flex md:gap-3 md:mx-0 py-4 hover:bg-purple-200/50 md:-mx-2 md:px-6 px-4  hover:-mx-2 rounded-md hover:shadow-md transition-all hover:scale-105";
    ...
    <>
      <Card>
        <div className="flex md:block justify-center">
          ...
          <Link
            className={
              asPath === "/profile/friends" ? activeElement : hoveredElement
            }
