...
function ProfileTabs({userId, active}) {
  ...
  return (
    <div className='pl-5 flex pb-5 items-center gap-4'>
            <div>
              <Link href={`/profile/${userId}/posts`} className={active === 'posts' ? activetab : nonActiveTab}>
            ...
            <div>
              <Link href={`/profile/${userId}/about`} className={active === 'about' ? activetab : nonActiveTab}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            <div>
              <Link href={`/profile/${userId}/friends`} className={active === 'friends' ? activetab : nonActiveTab}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            <div >
              <Link href={`/profile/${userId}/photos`} className={active === 'photo' ? activetab : nonActiveTab}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
