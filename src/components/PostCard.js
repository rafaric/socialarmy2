...
function PostCard({id, content,created_at,photos, profiles:authorProfile}) {
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118 9.75v-.7V9A6 6 0 006 9v.75a8.967 8.967 0 01-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 01-5.714 0m5.714 0a3 3 0 11-5.714 0M3.124 7.5A8.969 8.969 0 015.292 3m13.416 0a8.969 8.969 0 012.168 4.5" />
              ...
              <a className='flex gap-2 py-2 hover:bg-purple-200/50 -mx-2 px-2   hover:py-2 rounded-md hover:shadow-md transition-all hover:scale-105'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
...
Borrar</a>
      ...
      <div className='flex mt-3 gap-5'>
        <button className='flex gap-2 items-center' onClick={toggleLike}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={"w-6 h-6 "+(isLikesByMe? "fill-red-500" : "")}>
