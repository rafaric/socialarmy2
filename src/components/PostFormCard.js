      ...
      <div className='flex mt-2 items-center gap-5'>
        <div>
          <label className='flex gap-2 hover:cursor-pointer'>
            ...
            <span className='hidden md:block'>Fotos</span></label>
        </div>
        <div>
          <button className='flex gap-2'>
            ...
            <span className='hidden md:block'>Personas</span></button>
        </div>
        <div>
          <button className='flex gap-2'>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            <span className='hidden md:block'>Lugares</span></button>
        </div>
        <div >
          <button className='flex gap-2'>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            <span className='hidden md:block'>Humor</span></button>
        </div>
        <div className='grow text-right'>
          <button onClick={createPost} className='bg-purple-600 text-white px-4 py-2 rounded-md'>
            Compartir
          </button>
        </div>
      </div>
